...
local c = {
  ...
  purple    = "#C197FD", -- types, classes, TSType
  yellow    = "#E5C697", -- strings, attributes
  cyan_dim  = "#62D6E8", -- numbers, bool, special chars
  green     = "#20E3B2", -- functions, methods
  pink      = "#FF6BCB", -- keywords, operators
  cyan      = "#8BE9FD", -- constants, builtins, links
  muted     = "#7e7eb5", -- comments, line numbers
  bright_fg = "#F1F2F8", -- bright foreground

  -- UI chrome
  bg_dark   = "#0e0e1c", -- statusline, tabline
  bg_float  = "#1a1a2e", -- floating windows, sidebars
  bg_visual = "#2a2a50", -- visual selection
  bg_cursorline = "#1c1c2e",
  border    = "#373760", -- borders, separators
  selection = "#44475a",
...
vim.g.terminal_color_1  = "#C197FD"
vim.g.terminal_color_2  = "#E5C697"
vim.g.terminal_color_3  = "#62D6E8"
vim.g.terminal_color_4  = "#20E3B2"
vim.g.terminal_color_5  = "#FF6BCB"
vim.g.terminal_color_6  = "#8BE9FD"
vim.g.terminal_color_7  = "#E9E9F4"
vim.g.terminal_color_8  = "#373760"
vim.g.terminal_color_9  = "#C197FD"
vim.g.terminal_color_10 = "#E5C697"
vim.g.terminal_color_11 = "#62D6E8"
vim.g.terminal_color_12 = "#20E3B2"
vim.g.terminal_color_13 = "#FF6BCB"
vim.g.terminal_color_14 = "#8BE9FD"
