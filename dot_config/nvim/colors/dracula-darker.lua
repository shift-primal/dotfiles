...
<<<<<<< HEAD
  ...
  purple    = "#f38ba8",    -- c1: types, classes
  yellow    = "#a6e3a1",    -- c2: strings, attributes
  cyan_dim  = "#f9e2af",    -- c3: numbers, booleans
  green     = "#89b4fa",    -- c4: functions, methods
  pink      = "#f5c2e7",    -- c5: keywords, operators (accent)
  cyan      = "#94e2d5",    -- c6: constants, builtins
  muted     = "#7f849c",  -- comments, line numbers
  bright_fg = "#a6adc8",  -- bright foreground

  -- UI chrome (derived from palette)
  bg_dark       = "#1a1a28",
  bg_float      = "#262737",
  bg_visual     = "#2e344c",
  bg_cursorline = "#242535",
  border        = "#585b70",
  selection     = "#3b3c4f",
